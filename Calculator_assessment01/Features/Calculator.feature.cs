...
namespace Calculator_assessment01.Features
{
...
#line hidden
        ...
        public CalculatorFeature(CalculatorFeature.FixtureData fixtureData, Calculator_assessment01_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Mul two numbers")]
        [Xunit.TraitAttribute("FeatureTitle", "Calculator")]
        [Xunit.TraitAttribute("Description", "Mul two numbers")]
...
#line hidden
#line 25
 testRunner.Then("the result should be 800", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
